...
namespace WeddingBidders.Infrastructure.Seeding;
...
public class SeedingService
{
    ...
    public SeedingService(IWeddingBiddersContext context, IPasswordHasher passwordHasher)
    {
        _context = context;
    ...
    {
        var aggregates = new[] { "User", "Role", "Profile", "InvitationToken" };
